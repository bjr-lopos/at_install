...
def testTDoA(): 
    ...
    loposPy.insertTodo(0x1001, SFidx, cfg.LOPOS_SCENARIO_TDoA, 10, 0, 0)
    loposPy.insertTodo(0x1002, SFidx, cfg.LOPOS_SCENARIO_TDoA, 11, 0, 0)
    loposPy.insertTodo(0x1004, SFidx, cfg.LOPOS_SCENARIO_TDoA, 12, 0, 0)
    loposPy.insertTodo(0x1064, SFidx, cfg.LOPOS_SCENARIO_TDoA, 13, 0, 0)
...
def testDiscover(anchor, dev): 
    ...
    loposPy.insertTodo(dev, SFcnt, cfg.LOPOS_SCENARIO_Discover, 16, 0, 0)
...
def scheduleStatsCB(addr, last):
    print("scheduleStatsCB: " + repr(addr) + " "+ last )
...
def scheduleStats():
    ...
    actorCnt = 0
    SFcnt = loposPy.geNextSFidxRef()
    loposPy.checkForSchedules("stat", cfg.LOPOS_SCENARIO_Stat, 10, None)
